...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <logo>SharedDocuments/BizFi_Logo.png</logo>
    <primaryTabColor>#0070D2</primaryTabColor>
    <pushNotifications>
        <pushNotification>
            <fieldNames>Lead_Status_Category__c</fieldNames>
            <objectName>Lead</objectName>
        </pushNotification>
        <pushNotification>
            <fieldNames>McaApp__Funded__c</fieldNames>
    ...
    <tab>McaApp__Payable__c</tab>
    <tab>McaApp__Receivable__c</tab>
    <tab>Sales_Rep_Report_Card__c</tab>
    <workspaceMappings>
        <mapping>
            <fieldName>McaApp__Opportunity__c</fieldName>
            <tab>McaApp__Payable__c</tab>
        </mapping>
        <mapping>
            <fieldName>McaApp__Opportunity__c</fieldName>
