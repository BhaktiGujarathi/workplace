trigger StipscStats on Stips__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('Stips__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
