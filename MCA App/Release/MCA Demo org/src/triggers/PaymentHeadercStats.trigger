trigger PaymentHeadercStats on Payment_Header__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('Payment_Header__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
