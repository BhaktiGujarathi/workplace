trigger ReceiptcStats on Receipt__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('Receipt__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
