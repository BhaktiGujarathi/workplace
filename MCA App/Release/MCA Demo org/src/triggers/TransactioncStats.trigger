trigger TransactioncStats on Transaction__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('Transaction__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
