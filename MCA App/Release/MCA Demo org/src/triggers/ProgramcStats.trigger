trigger ProgramcStats on Program__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('Program__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
