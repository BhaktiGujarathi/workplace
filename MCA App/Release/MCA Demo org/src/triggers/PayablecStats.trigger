trigger PayablecStats on Payable__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('Payable__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
