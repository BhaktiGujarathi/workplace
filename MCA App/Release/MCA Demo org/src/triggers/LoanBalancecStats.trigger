trigger LoanBalancecStats on Loan_Balance__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('Loan_Balance__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
