trigger ReceivablecStats on Receivable__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('Receivable__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
