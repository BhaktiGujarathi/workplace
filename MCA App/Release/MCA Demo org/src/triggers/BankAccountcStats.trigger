trigger BankAccountcStats on Bank_Account__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('Bank_Account__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
