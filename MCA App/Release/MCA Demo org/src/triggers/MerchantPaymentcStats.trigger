trigger MerchantPaymentcStats on Merchant_Payment__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('Merchant_Payment__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
