trigger PaymentcStats on Payment__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('Payment__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
