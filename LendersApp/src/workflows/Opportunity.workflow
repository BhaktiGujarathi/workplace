...
&apos;&apos;)</formula>
    ...
    <fieldUpdates>
        <fullName>Populate_Date_Applied_Field</fullName>
        <field>Date_Applied__c</field>
        <formula>CreatedDate</formula>
        <name>Populate Date Applied Field</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Set_Opportunity_Reassign_Underwriter</fullName>
        <field>Reassign_Underwriter__c</field>
        <literalValue>1</literalValue>
        <name>Set Opportunity Reassign Underwriter</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Update_Interviewee_With_Owner1</fullName>
        <field>Interviewee__c</field>
        <formula>McaApp__Owner_1__r.FirstName + &apos; &apos; +  McaApp__Owner_1__r.LastName</formula>
        <name>Update Interviewee With Owner1</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Update_Last_Underwriting_Stage_Change</fullName>
        <field>Last_Underwriting_Stage_Change__c</field>
        <formula>IF( OR(ISCHANGED(  Underwriting_Stage__c  ), ISNEW() ), NOW() ,  Last_Underwriting_Stage_Change__c  )</formula>
        <name>Update Last Underwriting Stage Change</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <rules>
        <fullName>Create%3A Populate Date Applied field</fullName>
        <actions>
            <name>Populate_Date_Applied_Field</name>
    ...
    <rules>
        <fullName>Opportunity %3E set Last UW Stage Change Date</fullName>
        <actions>
            <name>Update_Last_Underwriting_Stage_Change</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
        ...
        <description>This workflow rule updates the &apos;Last Stage Change Date&apos; when Opportunity UW stage changes</description>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>Reassign Opportunity to Underwriter</fullName>
        <actions>
            <name>Set_Opportunity_Reassign_Underwriter</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>create%3A Update Interviewee with Owner Name</fullName>
        <actions>
            <name>Update_Interviewee_With_Owner1</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <formula>IF( OR( ISBLANK( Interviewee__c ), ISNULL( Interviewee__c )), true, false)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <tasks>
        <fullName>McaApp__Email_Funding_Application</fullName>
        <assignedTo>lendersdev@cloudmybiz.com.dev</assignedTo>
