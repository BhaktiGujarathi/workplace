...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>Send_Emails_From_Opportunity_List_View/Email_Stips</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        <fullName>Sent_Email_To_Owner</fullName>
        <ccEmails>attaranjum7@gmail.com</ccEmails>
        <description>Sent Email To Owner</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
        <senderType>CurrentUser</senderType>
        <template>Renwal_Template/Test_Email_Template</template>
    </alerts>
    <alerts>
        ...
        <protected>false</protected>
        <senderType>CurrentUser</senderType>
        <template>Renwal_Template/Renewal_Template_4</template>
    </alerts>
    <alerts>
